...
sm.set_array([])
plt.colorbar(sm, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig.tight_layout()
...
# Normalizer
norm1 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm1 = plt.cm.ScalarMappable(cmap=cmap, norm=norm1)
sm1.set_array([])
plt.colorbar(sm1, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig1.tight_layout()
...
# Normalizer
norm2 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm2 = plt.cm.ScalarMappable(cmap=cmap, norm=norm2)
sm2.set_array([])
plt.colorbar(sm2, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig2.tight_layout()
...
# Normalizer
norm3 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm3 = plt.cm.ScalarMappable(cmap=cmap, norm=norm3)
sm3.set_array([])
plt.colorbar(sm3, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig3.tight_layout()
...
# Normalizer
norm4 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm4 = plt.cm.ScalarMappable(cmap=cmap, norm=norm4)
sm4.set_array([])
plt.colorbar(sm4, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig4.tight_layout()
...
# Normalizer
norm5 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm5 = plt.cm.ScalarMappable(cmap=cmap, norm=norm5)
sm5.set_array([])
plt.colorbar(sm5, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig5.tight_layout()
...
# Normalizer
norm7 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm7 = plt.cm.ScalarMappable(cmap=cmap, norm=norm7)
sm7.set_array([])
plt.colorbar(sm7, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig7.tight_layout()
...
# Normalizer
norm8 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm8 = plt.cm.ScalarMappable(cmap=cmap, norm=norm8)
sm8.set_array([])
plt.colorbar(sm8, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig8.tight_layout()
...
# Normalizer
norm9 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm9 = plt.cm.ScalarMappable(cmap=cmap, norm=norm9)
sm9.set_array([])
plt.colorbar(sm9, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig9.tight_layout()
...
# Normalizer
norm10 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm10 = plt.cm.ScalarMappable(cmap=cmap, norm=norm10)
sm10.set_array([])
plt.colorbar(sm10, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig10.tight_layout()
...
# Normalizer
norm11 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm11 = plt.cm.ScalarMappable(cmap=cmap, norm=norm11)
sm11.set_array([])
plt.colorbar(sm11, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig11.tight_layout()
...
# Normalizer
norm12 = mpl.colors.Normalize(vmin=6638, vmax=7334) 
# creating ScalarMappable
sm12 = plt.cm.ScalarMappable(cmap=cmap, norm=norm12)
sm12.set_array([])
plt.colorbar(sm12, ticks=np.linspace(6600, 7400, 9),label='FillNumber')
fig12.tight_layout()
