...
# Normalizer
norm = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm = plt.cm.ScalarMappable(cmap=cmap, norm=norm)
sm.set_array([])
plt.colorbar(sm, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig.tight_layout()
...
# Normalizer
norm1 = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm1 = plt.cm.ScalarMappable(cmap=cmap, norm=norm1)
sm1.set_array([])
plt.colorbar(sm1, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig1.tight_layout()
...
# Normalizer
norm2 = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm2 = plt.cm.ScalarMappable(cmap=cmap, norm=norm2)
sm2.set_array([])
plt.colorbar(sm2, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig2.tight_layout()
...
# Normalizer
norm3 = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm3 = plt.cm.ScalarMappable(cmap=cmap, norm=norm3)
sm3.set_array([])
plt.colorbar(sm3, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig3.tight_layout()
...
# Normalizer
norm4 = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm4 = plt.cm.ScalarMappable(cmap=cmap, norm=norm4)
sm4.set_array([])
plt.colorbar(sm4, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig4.tight_layout()
...
# Normalizer
norm5 = mpl.colors.Normalize(vmin=6638, vmax=7334) #2018
# creating ScalarMappable
sm5 = plt.cm.ScalarMappable(cmap=cmap, norm=norm5)
sm5.set_array([])
plt.colorbar(sm5, ticks=np.linspace(6600, 7400, 9),label='FillNumber') #2018
fig5.tight_layout()
